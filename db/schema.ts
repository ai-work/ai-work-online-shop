...
export const products = pgTable('products', {
    ...
    return {
        ...
        sizeIndex: uniqueIndex('size_idx').on(products.sizeId),
        colorIndex: uniqueIndex('color_idx').on(products.colorId),
    }
});
...
export const orders = pgTable('orders', {
    ...
    return {
        storeIndex: uniqueIndex('store_idx').on(orders.storeId)
    }
});
...
export const sizes = pgTable('sizes', {
    ...
    return {
        storeIndex: uniqueIndex('store_idx').on(sizes.storeId)
    }
});
...
export const colors = pgTable('colors', {
    ...
    return {
        storeIndex: uniqueIndex('store_idx').on(colors.storeId)
    }
});
